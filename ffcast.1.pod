...
Take a screenshot of a window including its window manager frame (almost
equivalent to C<import -frame>):

    ffcast -qfw ffmpeg -loglevel quiet -- -frames:v 1 win.png
